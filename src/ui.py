...
def set_font_weight(font, weight):
    """Helper function to set font weight compatible with both PyQt5 and PySide6"""
    if QT_VERSION == "PySide6":
        # PySide6 uses enum values
        if weight == 75:
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.language_page.setObjectName(u"language_page")
        self.language_page.setMaximumSize(QSize(1081, 651))
        self.language_bg_label = QLabel(self.language_page)
        self.language_bg_label.setObjectName(u"language_bg_label")
        self.language_bg_label.setEnabled(False)
        self.language_bg_label.setGeometry(QRect(-30, -80, 1311, 741))
        self.language_bg_label.setStyleSheet(u"border-image: url(:/Graphics/bg.png);")
        
        # Language selection content
        self.language_content_frame = QFrame(self.language_page)
        self.language_content_frame.setObjectName(u"language_content_frame")
        self.language_content_frame.setGeometry(QRect(50, 50, 980, 550))
        self.language_content_frame.setStyleSheet(u"QFrame { background-color: rgba(0, 0, 0, 0.3); border-radius: 10px; }")
        ...
        self.about_button.setGeometry(QRect(0, 485, 168, 80))
        ...
        self.language_button = QPushButton(self.PagesFrame)
        self.language_button.setObjectName(u"language_button")
        self.language_button.setGeometry(QRect(0, 565, 168, 80))
        self.language_button.setFont(font6)
        self.language_button.setStyleSheet(u"")
    ...
    def retranslateUi(self, MainWindow):
            MainWindow.setWindowTitle(QCoreApplication.translate("MainWindow", u"CRTY PUBG Mobile Tool", None))
            ...
            self.about_label_text.setText(QCoreApplication.translate("MainWindow",
                                                                     u"<h2>Optimize Your PUBG Mobile Experience with CRTY PUBG Mobile Tool</h2>\n"
                                                                     "\n"
                                                                     "                                <h3>Features:</h3>\n"
                                                                     "                                <ul>\n"
                                                                     ...
                                                                     "                                <li>Multi-language support (English, Turkish, Arabic).</li>\n"
                                                                     "                                <li>Professional system optimization tools.</li>\n"
                                                                     "                                </ul>\n"
                                                                     "\n"
                                                                     "                                <h3>About CRTY Apps:</h3>\n"
                                                                     "                                <ul>\n"
                                                                     "                                <li>Professional optimization tool for PUBG Mobile</li>\n"
                                                                     "                                <li>Version: 2.0.0 - Enhanced with modern features</li>\n"
                                                                     "                                <li>Built with PySide6 for better performance</li>\n"
                                                                     "                                </ul>\n"
                                                                     "                                <center>\n"
                                                                     "                                <p><b>Level up your gaming experience today!</b></p>\n"
                                                                     "                                <p>© 2024 CRTY Apps. All rights reserved.</p>\n"
                                                                     "                                </center>\n"
                                                                     "                            ", None))
            self.appname_label.setText(QCoreApplication.translate("MainWindow", u"CRTY PUBG Mobile Tool v1.0.0", None))
            ...
            self.language_button.setText(QCoreApplication.translate("MainWindow", u"Language", None))
    # retranslateUi